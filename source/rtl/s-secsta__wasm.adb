...
--  XXX This is modified version of the standard package to workaround bug
--  with incorrect set of parameters for indirect call.
...
--      Stack    : constant SS_Stack_Ptr := Get_Sec_Stack.all;
      Stack    : constant SS_Stack_Ptr := Get_Sec_Stack_NT;
      Mem_Size : Memory_Size;
