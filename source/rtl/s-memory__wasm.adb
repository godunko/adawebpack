...
package body System.Memory is
   ...
   Heap_Base : Character;
   for Heap_Base'Alignment use Standard'Maximum_Alignment;
   pragma Import (C, Heap_Base, "__heap_base");
...
--   --  The address of the variable is the end of the heap
   ...
   Top : aliased Address := Heap_Base'Address;
   ...
   begin
      ...
      --  XXX Code is commented out because amount of memory is configurable
      --  during linking/instantiation and can grow on request. This code
