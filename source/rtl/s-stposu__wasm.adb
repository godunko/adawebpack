...
--  XXX exceptions propagation is not supported on WASM target
--   exception
--      when others =>
--
...
--  XXX exception propagation is not supported on WASM
--         exception
--            when others =>
--
...
--  XXX exception propagation is not supported
--         exception
